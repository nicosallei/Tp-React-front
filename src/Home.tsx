    ...
    return (
        <>
            <div>
                ...
                <h1 style={{ textAlign: "center", fontFamily: "Arial", fontSize: "48px", color: "lightblue", textTransform: "uppercase" }}>Musical Hendrix</h1>
                <div
                    id="carouselExample"
                ...
                <div style={{ padding: "20px" }}>
                    <h4>Musical Hendrix es una tienda de instrumentos musicales con ya más
